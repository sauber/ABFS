...
# Common test plan for all Device type modules. Requires Coverage.
...
for my $modulename ( grep /Device::/, all_modules() ) {
  ...
  ok( exists $prop->{Devops}, "$modulename prop Devops");
