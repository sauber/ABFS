...
#our (@ISA);
#@ISA =
#  qw(ABFS::IO::Handle ABFS::IO::Seekable);

=head1 NAME

ABFS::IO::File - A Big File System File 
...
Handle file operations. Inherits functions from Handle and Seekable.
